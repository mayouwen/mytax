...
<form name="form1" action="" method="post">
    <div class="p_d_1">
            ...
            <div class="content_info">
                ...
                <div class="t_list" style="margin:0px; border:0px none;">
                    <table width="100%" border="0">
                        ...
                        <s:iterator value="pageBean.pageData" status="st">
        ...
        <s:if test="pageBean.totalCount>0">
		<table width="100%" class="pageDown" border="0" cellspacing="0"
			cellpadding="0">
			<tr>
				<td align="right">
                 	总共<s:property value="pageBean.totalCount" />条记录，当前第 <s:property value="pageBean.currentPage" /> 页，共<s:property value="pageBean.totalPage" /> 页 &nbsp;&nbsp;
                            <a href="#">上一页</a>&nbsp;&nbsp;<a href="#">下一页</a>
					到&nbsp;<input type="text" style="width: 30px;" onkeypress="if(event.keyCode == 13){doGoPage(this.value);}" min="1"
					max="" value="<s:property value="pageBean.currentPage" />" /> &nbsp;&nbsp;
			    </td>
			</tr>
		</table>
		</s:if><s:else>
